...
public class SnowflakeIdUtils {
    ...
    /** 开始时间截 (2011-01-01) */
    private final long reductionTimestamp = 1293811200000L;
    ...
    private static final SnowflakeIdUtils ID_WORKER = new SnowflakeIdUtils(getWorkId(), getDataCenterId());
    ...
    public synchronized long nextId() {
        ...
        return ((timestamp - reductionTimestamp) << timestampLeftShift)
